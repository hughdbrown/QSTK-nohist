...
def getNYSEdays(startday=None, endday=None, timeofday=None):
    """
    ...
    @rtype datetime
    """
    startday = startday or dt.datetime(1964, 7, 5)
    endday = endday or dt.datetime(2020, 12, 31)
    timeofday = timeofday or dt.timedelta(0)
